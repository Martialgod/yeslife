(function(){
	...
	app.controller('BroadcastController', ['$http', 'SQLSTATEFactory', 'API_URL', 'GlobalFactory', function($http, SQLSTATEFactory, API_URL, GlobalFactory ){

		var vm = this;

		vm.pk_ordermstr = $('#pk_ordermstr').val();
		...
		vm.SendMail = function(){
			...
			var submitemail = function(){
				...
				$http.post('/admin/orders/'+vm.pk_ordermstr+'/broadcast', { 
					...
					if( vm.executioncounter < vm.customers.length ){	
						...
						//reload fist page
						location.href = '/admin/orders/'+vm.pk_ordermstr+'/broadcast';
						return;
