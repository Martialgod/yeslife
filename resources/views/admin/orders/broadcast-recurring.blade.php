...
<html>
  <head>
    ...
    <title>New Order Recurring Order for Approval</title>
    <style>
      /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="preheader">
              New Recurring Order for Approval
            </span>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <p>Hi {{$users['fullname']}},</p>


                        <p>
                          You have new recurring order that needs approval.

                        </p>

                        <p style="font-size: 12px; margin-top: -20px;color:red;">
                          <br>
