  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        ...
        <!-- Checkout Form-->
        <form id="form-checkout" class="jqvalidate-form checkout-form"  method="POST" action="#" v-on:submit.prevent="ConfirmCheckout()" >
              ...
              <div id="billing-form" class="mb-10">
                ...
                <div class="row">
                   ...
                   <div class="col-md-6 col-12 mb-20">
                       ...
                       <input type="email" class="form-control" id="billingemail" name="billingemail" placeholder="Email" required="" maxlength="255" value="{{$users['email']}}">
                   </div>
            ...
            <div class="col-lg-5">
                  ...
                  <div class="col-12 mb-60">
                     	...
                     	<div class="checkout-cart-total">
                       	...
                       	<p v-if="msccoupons.length >0 ">Coupon(s)</p>
                       	<ul>
                       		<li v-for="list in msccoupons">
                       			@{{list.code}}
                       	...
                       	<h4>Grand Total <span>$@{{totalnetamount}}</span></h4>
