...
@section('title', 'YesLife Reset Password')
                    ...
                    <div class="login-register-form">{{--login-register-form--}}
                        ...
                        <form method="POST" name="login-form" class="jqvalidate-form-2" action="" >
					        ...
					        <div class="" >
                                ...
                                <div class="form-group">
                                    <label for="password_confirmation">Repeat Password <span class="label-required">*</span> </label>
                                ...
                                <div class="col-12" style="text-align:center">
                                    <button type="submit" class="btn btn-round btn-lg">Reset Password</button>
                                </div>
