...
<div class="col-lg-12 col-12 mb-30 d-flex">
    ...
    <div class="checkout-cart-total" >
        ...
        <div style="color:#ffffff;">
          ...
          <input style="color:#fff;" class="credit-card-number" type="text" id="rally_cardNumber" placeholder="XXXX XXXX XXXX XXXX" data-input="rally_cardNumber" value="{{$users['cardno']}}" maxlength="19" required="">
        ...
        <div class="row">
            <div class="col-md-6 mb-20">
              ...
              <input style="color:#fff;" class="credit-card-expiry" type="text" id="rally_expDate" placeholder="MM/YYYY" data-input="rally_expDate" maxlength="7" value="{{$users['expdate']}}">
              <span id="errrally_expDate" style="color:red; font-size: 12px;"> </span>
            </div>

          <div class="col-md-6 mb-20">
              <label style="color:#ffffff;">CVC *</label>
              <input style="color:#fff;" type="text" id="rally_cvc" placeholder="XXX" data-input="rally_cvc" maxlength="4" value="{{$users['cvc']}}">
