                ...
                @include('admin.layouts.alert')
                 ...
                 <div class="contact-form sm-res-mg-t-30 tb-res-mg-t-30 tb-res-mg-t-0 bglight">
                    ...
                    <div class="contact-form-int">
                        ...
                        <form method="POST" class="swa-confirm"  action="{{route('users.update', $users->id)}}" >
                            ...
                            <div class="form-group">
                                <div class="form-single nk-int-st widget-form">
                                    ...
                                    <input type="text" class="form-control" id="fullname" name="fullname" placeholder="" required="" value="{{$users->fullname}}" maxlength="15">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-single nk-int-st widget-form">
                                    ...
                                    <input type="text" class="form-control" id="uname" name="uname" placeholder="" required="" value="{{$users->uname}}" maxlength="15" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-single nk-int-st widget-form">
                                    ...
                                    <select name="stat" id="stat" class="form-control">
                                        <option value="1" {{ $users->stat == '1' ? 'selected' : '' }}>Active</option>
                                        <option value="0" {{ $users->stat == '0' ? 'selected' : '' }}>In-Active</option>
                                    </select>
