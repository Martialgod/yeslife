      ...
      <div class="container" ng-app="app" ng-controller="CartController as vm">
          <div class="row">
                ...
                <div hidden id="divtblcartcontent">
                    ...
                    <form action="# method="POST" id="form-checkout" name="form-checkout" >

                        {{method_field('POST')}}
                        {{csrf_field()}}

                        <div class="col-md-4 alert alert-info" style="margin-right: 2px;" ng-repeat="list in vm.mscproducts">
                            ...
                            <div class="form-group">
                                <div class="form-single nk-int-st widget-form">
                                    ...
                                    <input type="number" name="qty[]" ng-model="list.selectedqty" string-to-number ng-change="vm.CalculateTotal()" ng-model-options="{debounce: 200}" >
                                </div>
                        ...
                        <hr>
                        <div style="text-align:center;" ng-if="vm.mscproducts.length>0">
                            <h3>
                              Total Net: @{{vm.totalnetamount}}
                            </h3>
                    ...
                    {{--
                    <button type="button" class="btn btn-success notika-btn-success waves-effect" ng-click="vm.testAuthorize()">Authorize</button>
                    --}}
